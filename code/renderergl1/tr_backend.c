...
#ifdef __PSP__
	Sys_PSP_RenderProfileBegin( PSP_RPROF_BACKEND_SURFS );
#endif
	RB_RenderDrawSurfList( cmd->drawSurfs, cmd->numDrawSurfs );
#ifdef __PSP__
	Sys_PSP_RenderProfileEnd( PSP_RPROF_BACKEND_SURFS );
#endif
...
void RB_ExecuteRenderCommands( const void *data ) {
	int		t1, t2;
#ifdef __PSP__
	qboolean	backendProfileEnded = qfalse;
#endif
...
#ifdef __PSP__
			Sys_PSP_RenderProfileEnd( PSP_RPROF_BACKEND_CMDS );
			backendProfileEnded = qtrue;
#endif
