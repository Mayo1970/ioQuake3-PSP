...
#ifdef __PSP__
	/* Keep the recursive walker uninstrumented: one rprof slot is not reentrant. */
	Sys_PSP_RenderProfileBegin( PSP_RPROF_WORLD );
#endif
	R_AddWorldSurfaces ();
#ifdef __PSP__
	Sys_PSP_RenderProfileEnd( PSP_RPROF_WORLD );
#endif
