...
// Platform headers (code/psp/psp_platform.h) may shrink this; the table is
// [SHADER_MAX_VERTEXES][MAX_EDGE_DEFS] in .bss and R_AddEdgeDef already drops
// edges past the cap.
#ifndef MAX_EDGE_DEFS
