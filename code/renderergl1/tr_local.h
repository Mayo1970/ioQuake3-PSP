...
// Platform headers (code/psp/psp_platform.h) may shrink this. It is paid for
// twice - backEndData_t::drawSurfs on the hunk and R_RadixSort's static
// scratch in .bss - and R_SortDrawSurfs clamps to it (tr_main.c:1385), so a
// smaller table costs dropped surfaces on overflow and nothing else.
#ifndef MAX_DRAWSURFS
