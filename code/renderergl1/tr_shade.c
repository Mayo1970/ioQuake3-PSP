...
#ifdef __PSP__
// After tr_local.h: shaderStage_t is an untagged typedef and cannot be
// forward declared. See code/psp/psp_tcmod.c for what these two do.
#include "../psp/psp_tcmod.h"
#include "../psp/psp_draw.h"
...
#ifdef __PSP__
	Sys_PSP_RenderProfileBegin( PSP_RPROF_DLIGHT );
#endif
#if idppc_altivec
...
#ifdef __PSP__
		Sys_PSP_RenderProfileEnd( PSP_RPROF_DLIGHT );
#endif
		return;
	}
#endif
...
#ifdef __PSP__
	Sys_PSP_RenderProfileBegin( PSP_RPROF_FOG );
#endif
	qglEnableClientState( GL_COLOR_ARRAY );
...
#ifdef __PSP__
	Sys_PSP_RenderProfileEnd( PSP_RPROF_FOG );
#endif
}
...
#ifdef __PSP__
	Sys_PSP_RenderProfileBegin( PSP_RPROF_COLORS );
#endif
	//
	// rgbGen
	//
...
#ifdef __PSP__
	Sys_PSP_RenderProfileEnd( PSP_RPROF_COLORS );
#endif
}
